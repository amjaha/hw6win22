...
def sort_price(CACHE_FNAME):
    ...
    -------
    tuple
        the name of the most expensive collection
...
def itunes_counts(CACHE_FNAME):
    ...
    dictionary in ascending order, returning the 
    three most frequent genres in the dict
    ...
    -------
    dict
        a dict with the three most frequnt genres 
